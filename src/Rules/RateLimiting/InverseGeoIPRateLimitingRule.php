...
/**
 * Matches all ip addresses NOT belonging to specific country. Each country has its counter.
 */
class InverseGeoIPRateLimitingRule extends AbstractRateLimitingRule implements IRule
{
	public const NAME = 'rl_geoip_inverse';
